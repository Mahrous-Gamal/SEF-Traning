...
function App() {
  ...
  const HeaderDisplay =
    ...
    window.location.pathname === "/forgetpassword" ? null : (
      <Header flag={flag} />
    );
  const FooterDisplay =
    window.location.pathname === "/signup" ||
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/CreateAndUpdatecourses"
          element={<CreateAndUpdatecourses />}
        />
        <Route
          path="/CreateNewsArticlePage"
        ...
        <Route
          path="/CourseShowPageEnrolled"
          element={<CourseShowPageEnrolled />}
        />
        <Route
          path="/CourseShowPagenotEnrolled"
          element={<CourseShowPageNotEnrolled />}
        />
