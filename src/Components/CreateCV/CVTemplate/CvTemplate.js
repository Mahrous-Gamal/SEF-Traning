      ...
      <div className="cv-template-container col-5">
        <div className="cv-template-left-side">
          <div className="cv-template-profileInfo">
            ...
            <h4 className="cv-template-profile-name">
              {formData.name} {formData.last} <br />
              <span className="cv-template-profile-profession">
                {formData.profession}
              </span>
            </h4>
            <div className="cv-template-profile-inputInfo d-flex flex-column ">
              <input
                type="text"
                className="cv-template-profile-inputInfo1  "
                value={formData.country}
              />
              <input
                type="text"
                className="cv-template-profile-inputInfo2 "
                value={formData.city}
              />
              <input
                type="text"
                className="cv-template-profile-inputInfo3"
                value={formData.mobile}
              />
              <input
                type="text"
                className="cv-template-profile-inputInfo4"
            ...
            <div className="cv-template-profile-awards">
              <h4 className="cv-template-profile-awards-heading">
                Honor & Award
              </h4>
              <div>
                  ...
                  return (
                    <div>
                      <div className="cv-template-awards-name">
                        ...
                        <span className="cv-template-award-year">
                          {formData.year[index]}
                        </span>
                      </div>
                      <p className="cv-template-award-info">
                        {formData.AwardDescription[index]}
                      </p>
                    </div>
                  );
                })}
            ...
            <div className="cv-template-profile-links">
              <h4 className="cv-template-profile-links-heading">
              ...
              {inputLinkFields.map((inputLink) => {
                if (inputLink.value.toUpperCase() === "LINKEDIN") {
                  return (
                    <a
                      href={inputLink.linkValue}
                      className="cv-template-link-style"
                    >
                      <AiFillLinkedin className="cv-template-profile-links-icon " />
                      <span className="cv-template-profile-links-icon-name ">
                        Linkedin
                      </span>
                    </a>
                  );
                          ...
                          <ul className="cv-template-education-Organization">
                            {formData.Organization.map((item, i) => {
                              if (formData.Organization[i] !== "") {
                                return (
                                  <li className="cv-template-education-Organization-list">
                                    <p className="cv-template-education-Organization-Name">
                                      {formData.Organization[i]}
                                    </p>
                          ...
                          <ul className="cv-template-experience-company">
                            {formData.company.map((item, i) => {
                              if (formData.company[i] !== "") {
                                return (
                                  <li className="cv-template-experience-company-list">
                                    <h3 className="cv-template-experience-company-name">
                                      {formData.company[i]}
                                    </h3>
                                    <p className="cv-template-experience-position">
                                      {formData.Position[i]}
                                      <span className="cv-template-experience-from-date">
                                        {formData.from[i]}
                                      </span>
                                      <span className="cv-template-experience-to-date">
                                        {formData.to[i]}
                                      </span>
                                    </p>
                                    <p className="cv-template-experience-desc">
