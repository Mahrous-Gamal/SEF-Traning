          ...
          <Row>
            <Col>
              <div className="d-flex justify-content-between ">
                <p className="header text-white text-capitalize position-relative">
                  business
                </p>
                <div className="img-clock d-md-none">
                  <FontAwesomeIcon icon={faClock} className="clock" />
                  <p className="text-white d-inline-block ms-1 clickTime">
                    {" "}
                    2 h ago{" "}
                  </p>
                </div>
              ...
              <div className="d-flex justify-content-between ">
                <h4 className="text-white text-uppercase headerTwo mb-4">
                  here's the fourth article
                </h4>
                <div className="d-none d-md-flex">
                  <FontAwesomeIcon icon={faClock} className="clock" />
                  <p className="text-white d-inline-block ms-2  clickTime">
                    {" "}
                    2 h ago{" "}
                  </p>
                </div>
          ...
          <Container>
            <Row>
              <Col sm={6} className="mx-auto my-4">
                <h3 className="text-white text-uppercase sub-title ">
                  subscribe to our newsleletter
                </h3>
                <p className="text-white my-3 sub-text ">
                  Be the first to get latest news
                </p>
                <div className="d-flex flex-column flex-lg-row mt-4 ">
                  <Form.Control
                    className="input-sub my-2"
                    size="lg"
                    type="text"
                  ></Form.Control>
